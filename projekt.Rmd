...
Neka je $w_i$ reaizacija broja aseva pobjednika i $l_i$ realizaija broja aseva gubitnika,
...
2. T-test pretpostavlja da su varijance jednake
...
Provodim Lilliefors test nad podatcima
```{r}
...
```{r}
var.test(tennisMatches$w_ace, tennisMatches$l_ace)
```

#### Uvjeti testa
Zato što variance nisu jednake i distribucija $D$ populacije nije normalna, ali je zvonolika, zaključujem da je t-test aproksimativan,
zbog toga provodim i Jackknife, da utvrdim 99% interval za srednju vrijednost.
