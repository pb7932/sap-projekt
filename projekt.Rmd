...
t.test(extractedData, alt="two.sided")
...
### Test uparenih vrijednosti

Hipoteze uparenog t testa:
$$ \begin{aligned}
H_0&: \sigma_1^2 = \sigma_2^2 \\
H_1&: \sigma_1^2 \ >\sigma_2^2
\end{aligned} $$

$H_0$: očekivanje da igrači koji pobjede prvi set i ujedino i meč jednako je igračima koji izgube prvi set, a pobjede meč
$H_1$: očekivanje da igrači koji pobjede prvi set i ujedino i meč veće od očekivanja igrača koji izgube prvi set, a pobjede meč

```{r}
t.test(wonFirstSetAndMatchMatches, lostFirstSetAnWonMatchMatches, paired = TRUE, alternative = "two.sided")
```
